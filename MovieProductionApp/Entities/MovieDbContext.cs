...
namespace MovieProductionApp.Entities
{
	...
	public class MovieDbContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<ProductionStudio>().HasData(new ProductionStudio() { ProductionStudioId = 2, Name = "MPC Productions" });

			modelBuilder.Entity<MovieApiData>().HasData(
				new MovieApiData() { TimeOfOffer = new DateTime(2010, 03, 4), MovieId = 1, ProductionStudioId = 2, Availability = true },
				new MovieApiData() { TimeOfOffer = new DateTime(2012, 07, 16), MovieId = 2, ProductionStudioId = 2, Availability = false },
				new MovieApiData() { TimeOfOffer = new DateTime(2020, 09, 30), MovieId = 3, ProductionStudioId = 2, Availability = true }
			);
		}
	}
}
