    ...
    public class MovieDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MovieApiData>().HasData(
                new MovieApiData() { TimeOfOffer = new DateTime(2010, 03, 4), MovieId = 1, ProductionStudioId = 1, Availability = true },
                new MovieApiData() { TimeOfOffer = new DateTime(2012, 07, 16), MovieId = 2, ProductionStudioId = 1, Availability = false },
